...
const experiences = [
  {
    ...
    descriptionPT: "Formacao profissional em assistente administrativo pelo Senac, onde criei sites para apresentacoes de ideias e realizei interfaces virtuais para atividades.",
    ...
    responsibilitiesPT: [
      "Criacao de sites para apresentacoes",
      "Interfaces virtuais para atividades",
      "Formacao em assistente administrativo",
    ...
    tags: ["HTML", "CSS", "JavaScript", "Office"],
    gradient: "from-slate-600 to-slate-800",
  },
  {
    titlePT: "Jovem Aprendiz",
    titleEN: "Young Apprentice",
    company: "Pao dos Pobres",
    locationPT: "Porto Alegre, RS",
    locationEN: "Porto Alegre, Brazil",
    period: "09/2024 - 03/2025",
    periodEN: "Sep 2024 - Mar 2025",
    descriptionPT: "Desenhos tecnicos, projetos pedagogicos que automatizei e realizei apresentacoes de sites para outras turmas.",
    descriptionEN: "Technical drawings, pedagogical projects that I automated and presented websites to other classes.",
    responsibilitiesPT: [
      "Desenhos tecnicos",
      "Automacao de projetos pedagogicos",
      "Apresentacoes de sites",
      "Suporte tecnico",
    ],
    responsibilitiesEN: [
      "Technical drawings",
  ...
  },
  {
    ...
    descriptionPT: "Criacao de sites, lojas, portfolios, bots para Discord, chatbots para WhatsApp, landing pages e scripts para outras empresas.",
  ...
  },
  {
    ...
    descriptionPT: "Atuo no desenvolvimento front-end com React e TypeScript, criando interfaces com foco em funcionalidades de geolocalizacao e visualizacao de dados. Trabalho na integracao de LLMs e chatbot as aplicacoes.",
    ...
    responsibilitiesPT: [
      ...
      "Geolocalizacao e visualizacao de dados",
      "Integracao de LLMs e chatbots",
      "Arquitetura frontend e componentizacao",
    ],
    responsibilitiesEN: [
    ...
    tags: ["React", "TypeScript", "LLM", "GCP", "Docker"],
